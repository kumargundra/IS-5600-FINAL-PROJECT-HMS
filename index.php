...
<body>
    ...
    <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav bg-success">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="route/user-login.php">Book an Appointment</a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
                    <img src="assets/images/gallery/gallery_16.jpeg" class="img-responsive">
                </div>
